...
import { useSuperAdminProfile } from "@/hooks/superAdmin/useSuperAdminProfile";
import { AppLayout } from "@/layouts/AppLayout";
import { saveStoredProfilePhoto, removeStoredProfilePhoto } from "@/lib/superAdminProfile";
import { superAdminService } from "@/services/superAdminService";
import { getStoredOfficer, updateStoredOfficer } from "@/stores/authStore";

export function SuperAdminProfilePage() {
  const { data, loading, error, refresh } = useSuperAdminProfile();
          ...
          <div className="space-y-6">
            ...
            <EditProfileSection
              ...
              onSubmit={async (input) => {
                ...
                setActionError(null);
                try {
                  const updated = await superAdminService.updateProfile({ ...input, current: data });
              ...
              onSubmit={async (currentPassword, newPassword, confirmPassword) => {
                ...
                try {
                  await superAdminService.changePassword({
                    ...
                    username: getStoredOfficer()?.username ?? "",
                    currentPassword,
                    newPassword,
                  });
