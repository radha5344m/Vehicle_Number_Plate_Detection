...
export function InvestigationReportsFiltersBar({ filters, onApply, onReset }: Props) {
  ...
  return (
    ...
    >
      <Input
        ...
        placeholder="Reg no / owner / officer / vehicle / ID"
      />
      <Input
        type="date"
        name="from"
      ...
      <Input
        ...
        value={draft.police_station}
        onChange={(event) => updateDraft("police_station", event.target.value)}
      />
      <Input
        name="district"
        label="District"
